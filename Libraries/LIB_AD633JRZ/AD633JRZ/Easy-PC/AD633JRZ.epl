SamacSys ECAD Model
3500/1279862/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "AD633JRZ" (originalName "AD633JRZ")
	...
	(compDef "AD633JRZ" (originalName "AD633JRZ") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "Y1") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "Y2") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "-VS") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "Z") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "X2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "X1") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "+VS") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "W") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AD633JRZ"))
		...
		(attr "Mouser Part Number" "584-AD633JRZ")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Analog-Devices/AD633JRZ?qs=NmRFExCfTkHsQMKUgIw9Ig%3D%3D")
		(attr "Manufacturer_Name" "Analog Devices")
		(attr "Manufacturer_Part_Number" "AD633JRZ")
		(attr "Description" "AD633JRZ, Analogue Multiplier 4-Bits 8-Pin SOIC")
		(attr "Datasheet Link" "http://www.analog.com/static/imported-files/data_sheets/AD633.pdf")
		(attr "Height" "1.75 mm")
	)
