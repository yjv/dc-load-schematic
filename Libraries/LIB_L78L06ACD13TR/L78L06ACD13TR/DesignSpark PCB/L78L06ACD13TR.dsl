SamacSys ECAD Model
179469/1279862/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "L78L06ACD13TR" (originalName "L78L06ACD13TR")
	...
	(compDef "L78L06ACD13TR" (originalName "L78L06ACD13TR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "7" (pinName "GND_4") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "GND_3") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "NC_2") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "L78L06ACD13TR"))
		...
		(attr "Mouser Part Number" "511-L78L06ACD-TR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/STMicroelectronics/L78L06ACD13TR?qs=nGCvt7cgQioRPwLhgxb%2FbQ%3D%3D")
		(attr "Manufacturer_Name" "STMicroelectronics")
		(attr "Manufacturer_Part_Number" "L78L06ACD13TR")
		(attr "Description" "L78L06ACD13TR, Voltage Regulator, 0.1A 6 V, +/-5%, 8-Pin, SOIC")
		(attr "Datasheet Link" "http://www.st.com/st-web-ui/static/active/en/resource/technical/document/datasheet/CD00000446.pdf")
		(attr "Height" "1.75 mm")
	)
