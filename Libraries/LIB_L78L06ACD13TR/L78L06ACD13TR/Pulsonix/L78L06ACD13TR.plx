...
(library Library_1
	...
	(compDef "L78L06ACD13TR" (originalName "L78L06ACD13TR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "7" (pinName "GND_4") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "GND_3") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "http://www.st.com/st-web-ui/static/active/en/resource/technical/document/datasheet/CD00000446.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "L78L06ACD13TR.stp")
