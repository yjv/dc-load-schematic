...
//414377/1279862/2.50/8/4/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "INA826AID" (originalName "INA826AID")
	...
	(compDef "INA826AID" (originalName "INA826AID") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "INA826AID"))
		...
		(attr "Mouser Part Number" "595-INA826AID")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/INA826AID?qs=RqytGdBYyUH0CDtkCzl1iw%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "INA826AID")
		(attr "Description" "Texas Instruments INA826AID Instrumentation Amplifier, 150uV Offset 1MHz GBW, CMMR 80dB, 2.7  36 V, 8-Pin SOIC")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/ina826")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "INA826AID.stp")
