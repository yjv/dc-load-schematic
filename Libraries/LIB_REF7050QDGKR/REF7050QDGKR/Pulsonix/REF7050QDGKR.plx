...
(library Library_1
	...
	(compDef "REF7050QDGKR" (originalName "REF7050QDGKR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "7" (pinName "OUTF") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "6" (pinName "OUTS") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "GND_3") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.ti.com/lit/ds/symlink/ref70.pdf?ts=1705897089094&ref_url=https%253A%252F%252Fwww.mouser.mx%252F")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "REF7050QDGKR.stp")
